...
$Proc = Start-Process `
    ...
    -ArgumentList "-NoProfile", "-ExecutionPolicy", "Bypass", "-File", (Join-Path $Root "start-server-optimized.ps1") `
...
Write-Host "Started llama-server (optimized MTP) with PID $($Proc.Id)"
